...
import { findRenderedDOMComponentWithClass, findRenderedDOMComponentWithTag } from 'react-dom/cjs/react-dom-test-utils.production.min';
class Contact extends Component {
    ...
    validade(firstname, lastname, telnum, email) {
        const errors = {
            firstname: '',
            lastname: '',
            telnum: '',
        ...
        else if (this.state.touched.telnum && telnum.length < 7)
