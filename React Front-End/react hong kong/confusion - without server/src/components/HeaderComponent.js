                ...
                <Navbar dark expand="md">
                    <div className="container" >
                        <div className='row'>
                            ...
                            <NavbarBrand className="mr-auto col-5 col-md-1 mt-0" href="/"><img src={BaseUrl + '/assets/images/logo.png'} height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
